...
public class BimDemoController extends JeecgController<BimDemo, IBimDemoService> {
    ...
    public Result<IPage<BimDemo>> queryPageList(BimDemo bimDemo, @RequestParam(name = "pageNo", defaultValue = "1") Integer pageNo, @RequestParam(name = "pageSize", defaultValue = "10") Integer pageSize, HttpServletRequest req) {
